...
Catalina base.
Вказуємо шлях до папки Сatalina, що, попередньо, створили
у корені проекту. Тут сгенеровані відповідні файли.
...
Context path.
Можемо прорисати просто /  або /spring-mvc-contact
...
http://localhost:8080/
або, якщо, попередньо прописали /spring-mvc-contact, то таке
http://localhost:8080/spring-mvc-contact
